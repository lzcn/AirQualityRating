...
% output:
%  eaf: feature files
function eaf = Extract_All_Features(file_dir,flag,feature_func,feature_file_dir,feature_file)
%% extract the origin features
TwoSets = {'TrainingSet','TestSet'};
prefix = {'train_','test_'};
...
for i = 1:2
    ...
    data_train_new = set_image_data(file_dir,TwoSets{i});
