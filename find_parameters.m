...
pnames = { 'svm_type' 'c_range' 'c_step' 'g_range' 'g_step' 'fold' 'train_filename' 'test_filename' 'svm_path'};
dflts =  {     5       [-5 15]    2       [3 -15]     -2       5       'train'          'test'       '.\bin'  };
[svm_type,c_range,c_step,g_range,g_step,fold,train_filename,test_filename,svm_path] ...
